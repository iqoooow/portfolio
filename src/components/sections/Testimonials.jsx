        ...
        <section id="testimonials" className="section-padding relative overflow-hidden">
            ...
            <div className="container max-w-5xl mx-auto text-center relative z-10">
                <div className="mb-20" data-aos="fade-up">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold font-heading mb-4 tracking-tight">
                ...
                <div className="relative glass-card p-8 sm:p-12 md:p-20 rounded-[3rem] mx-auto overflow-hidden group shadow-2xl border border-gray-200 dark:border-white/5" data-aos="zoom-in">
                    ...
                    <div className={`transition-all duration-500 ease-out transform ${isAnimating ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
                        {/* Rating stars */}
